  ...
  return (
    <footer className="bg-primary-navy text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Explore the Pearl of the Indian Ocean with our premium taxi and
              tour services.
            </p>
          ...
          <div className="animate-fade-in">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-gray-300 hover:text-primary-ocean transition-colors duration-300"
                >
                  Home
                </Link>
              </li>
        ...
        <div className="flex sm:justify-center items-center border-t border-gray-700 mt-8 pt-5">
